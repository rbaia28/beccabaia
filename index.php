	...
	<main class="container">
		<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
			<div class="col-md-6 px-0">
				...
				<p class="lead my-3">Multiple lines of text that form the led, informing new readers quickly and efficiently about what’s most interesting in this post’s contents.</p>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="p-4 mb-3 bg-light rounded">
					...
					<p class="mb-0"> I am a human. </p>
				</div>

				<div class="p-4">
					<h4 class="fst-italic">Previous Placements</h4>
